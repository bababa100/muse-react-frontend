...
class SongContainer extends Component {
  ...
  addSong = async (e, song) => {
    ...
    try {
      ...
      //this empties all the songs that are living in a state
      //and adding the song we just created at the end.
      //the new song is called parsedResponse.data
  ...
  deleteSong = async (id) => {
    ...
    // Now that the db deleted the item, we need to remove it from state
